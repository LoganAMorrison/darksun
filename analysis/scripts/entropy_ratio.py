...
if __name__ == "__main__":
    ...
    dheffs = [
        mod.dark_heff(xi * tsm) for xi, tsm, mod in zip(xifo, tsmfo, models)
    ]
    entropy_ratio = [
    ...
    plt.plot(eta_rd_cont[0], entropy_ratio)
    ...
    # plt.ylim([1e-4, 1e-1])
    plt.savefig(
        "/home/logan/Research/DarkSun/cpp/analysis/figures/entropy_ratio_xi_inf=1e-2.pdf"
    )
